...
import { RSBSelectComponent } from './rsb-select.component';


export const BASIC_WIDGETS = [
	AddReferenceComponent, OneOfComponent, ButtonComponent, CheckboxComponent,
	CheckboxesComponent, FileComponent, HiddenComponent, InputComponent, RSBSelectComponent,
...
export { RSBSelectComponent } from './rsb-select.component';

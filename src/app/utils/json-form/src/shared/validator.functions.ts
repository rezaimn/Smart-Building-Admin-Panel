...
export type SchemaType =
	'string' | 'number' | 'integer' | 'boolean' | 'null' | 'object' | 'array' | 'rsbselect';
...
export function isRsbSelect(value) {
	//return typeof value === 'rsbselect';
	return true;
}
/**
...
export function getType(value, strict: any = false) {
	...
	if (isRsbSelect(value)) { return 'rsbselect'; }

...
export class ViewSubsidiaryComponent implements OnInit {
    ...
    //     this
    //       .appService
    //       .sendHeaderWithLogo(this.organization.name, 'subsidairies', 'select Subsidairy', '','../../../../../assets/images/dashboard/SMART-PARKING-SYSTEM.png');
    //   }
    // }
                ...
                (subHeaderT) => {
                    ...
                    this.translate.get('page-details.manage-subsidiary', this.appService.currentLang).subscribe(
                        (pageDetailsT) => {
                            ...
                            this
                                .appService
                                .sendHeaderWithLogo(orgName, subHeader, pageDetails, "", '../../../../../assets/images/dashboard/SMART-PARKING-SYSTEM.png');
    ...
    storeSubsidiary(subsidiary) {
        ...
        let sideBarData = this.authenticationService.getSideBarContent('spms',this.appService.currentLang);
    ...
    updateBreadCrums() {
        this.appService.updateBreadCrums('SPMS-SUBSIDIARY');
    }

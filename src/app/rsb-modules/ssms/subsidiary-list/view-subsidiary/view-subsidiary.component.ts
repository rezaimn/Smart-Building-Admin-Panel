...
export class ViewSubsidiaryComponent implements OnInit {
    ...
    //     this
    //       .appService
    //       .sendHeaderWithLogo(this.organization.name, 'subsidairies', 'select Subsidairy', '','../../../../../assets/images/dashboard/SMART-SECURITY-SYSTEM.png');
    //   }
    // }
                ...
                (subHeaderT) => {
                    ...
                    this.translate.get('page-details.manage-subsidiary', this.appService.currentLang).subscribe(
                        (pageDetailsT) => {
                            ...
                            this
                                .appService
                                .sendHeaderWithLogo(orgName, subHeader, pageDetails, "", '../../../../../assets/images/dashboard/SMART-SECURITY-SYSTEM.png');
    ...
    storeSubsidiary(subsidiary) {
        ...
        let sideBarData = this.authenticationService.getSideBarContent('ssms',this.appService.currentLang);
    ...
    updateBreadCrums() {
        this.appService.updateBreadCrums('SSMS-SUBSIDIARY');
    }

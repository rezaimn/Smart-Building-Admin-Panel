...
export class ViewSubsidiaryComponent implements OnInit {
    ...
    //     this
    //       .appService
    //       .sendHeaderWithLogo(this.organization.name, 'subsidairies', 'select Subsidairy', '','../../../../../assets/images/dashboard/SIGNAGES-AND-KIOSKS.png');
    //   }
    // }
    ...
    storeSubsidiary(subsidiary) {
        ...
        let sideBarData = this.authenticationService.getSideBarContent('sk',this.appService.currentLang);
    ...
    updateBreadCrums() {
        this.appService.updateBreadCrums('SK-MANAGEMENT-LIST');
    }

...
export class ViewSubsidiaryComponent implements OnInit {
    ...
    //     this
    //       .appService
    //       .sendHeaderWithLogo(this.organization.name, 'subsidairies', 'select Subsidairy', '','../../../../../assets/images/dashboard/AMS.png');
    //   }
    // }
                ...
                (subHeaderT) => {
                    ...
                    this.translate.get('page-details.manage-subsidiary', this.appService.currentLang).subscribe(
                        (pageDetailsT) => {
                            ...
                            this
                                .appService
                                .sendHeaderWithLogo(orgName, subHeader, pageDetails, routeName, '../../../../../assets/images/dashboard/AMS.png');
    ...
    storeSubsidiary(subsidiary) {
        ...
        let sideBarData = this.authenticationService.getSideBarContent('ams',this.appService.currentLang);
    ...
    updateBreadCrums() {
        this.appService.updateBreadCrums('AMS-SUBSIDIARY');
    }

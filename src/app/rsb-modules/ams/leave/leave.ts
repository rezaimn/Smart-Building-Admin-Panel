...
export class SumbitLeaveData {
    public staffid: string;
    public leavetypeid: number;
    public leavefrom: string;
    ...
    constructor(data: any = {}) {
        ...
        this.leavetypeid= data.leavetypeid || 0;
        this.leavefrom = data.leavefrom || '';
        this.leaveto = data.leaveto || '';
        this.leavedays= data.leavedays || 0;
        this.leavehours= data.leavehours || 0;
        this.reasonforleave= data.reasonforleave || '';
    }
}
export class WorkTime {
    ...
    constructor(d : any = {}) {
        ...
        this.leavetypeid = d.leavetypeid || null;
        this.workStartTime = d.workStartTime || null;
        this.workEndTime = d.workEndTime || null;
        this.leavereason = d.leavereason || null;
        this.leavefrom = d.leavefrom || null;
        this.leaveto = d.leaveto || null;
    }
}
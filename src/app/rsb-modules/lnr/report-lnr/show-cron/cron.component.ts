...
import {
	Component, forwardRef, Inject, Injector, Input, OnChanges, OnDestroy, OnInit,
	SimpleChanges
} from '@angular/core';
...
import { SubmitComponent } from "app/utils/json-form";
...
export class CronJobsComponent implements OnInit, OnChanges, OnDestroy {
	...
	public activeTab: string='minutes';
	...
	constructor(public appService: AppService,
		private injector: Injector, public dialogRef: MatDialogRef<SubmitComponent>,

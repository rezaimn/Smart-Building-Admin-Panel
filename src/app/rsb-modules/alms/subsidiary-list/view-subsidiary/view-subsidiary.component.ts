...
export class ViewSubsidiaryComponent implements OnInit {
    ...
    //     this
    //       .appService
    //       .sendHeaderWithLogo(this.organization.name, 'subsidairies', 'select  subsidiary', '','../../../../../assets/images/dashboard/ALERT-MANAGEMENT-SYSTEM.png');
    //   }
    // }
    ...
    storeSubsidiary(subsidiary) {
        ...
        let sideBarData = this.authenticationService.getSideBarContent('alms',this.appService.currentLang);
    ...
    updateBreadCrums() {
        this.appService.updateBreadCrums('ALMS-SUBSIDIARY');
    }

...
export class ViewSubsidiaryComponent implements OnInit {
    ...
    //     this
    //       .appService
    //       .sendHeaderWithLogo(this.organization.name, 'subsidairies', 'select Subsidairy', '','../../../../../assets/images/dashboard/SMART-ENERGY-SAVING-SYSTEM.png');
    //   }
    // }
                ...
                (subHeaderT) => {
                    ...
                    this.translate.get('page-details.manage-subsidiary', this.appService.currentLang).subscribe(
                        (pageDetailsT) => {
                            ...
                            this
                                .appService
                                .sendHeaderWithLogo(orgName, subHeader, pageDetails, "", '../../../../../assets/images/dashboard/ALERT-MANAGEMENT-SYSTEM.png');
    ...
    storeSubsidiary(subsidiary) {
        ...
        let sideBarData = this.authenticationService.getSideBarContent('sems',this.appService.currentLang);
    ...
    updateBreadCrums() {
        this.appService.updateBreadCrums('SEMS-SUBSIDIARY');
    }

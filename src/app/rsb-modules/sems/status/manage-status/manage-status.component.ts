...
import { ManageArea, InstallationPoint, InstallationPointDevice, InstallationPointListItem } from '../status.interface';
...
export class ManageStatusComponent implements OnInit {
  ...
  //     this
  //       .appService
  //       .sendHeader(this.subsidiary.name, 'smart element management', 'real time status', '');
  //   }
  // }
  sendHeaderWithLogo(): void {
    ...
    if (this.subsidiary !== null) {
      this
        .appService
        .sendHeaderWithLogo(this.subsidiary.name, 'smart element management', 'real time status', '','../../../../../assets/images/dashboard/SMART-ENERGY-SAVING-SYSTEM.png');
    }
  }
...
// managing the status of the component
      if (svgTemp !== null) {

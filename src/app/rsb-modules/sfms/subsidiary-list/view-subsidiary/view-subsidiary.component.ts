...
export class ViewSubsidiaryComponent implements OnInit {
    ...
    //     this
    //       .appService
    //       .sendHeaderWithLogo(this.organization.name, 'subsidairies', 'select Subsidairy', '','../../../../../assets/images/dashboard/EMS.png');
    //   }
    // }
    ...
    storeSubsidiary(subsidiary) {
        ...
        let sideBarData = this.authenticationService.getSideBarContent('sfms',this.appService.currentLang);
    ...
    updateBreadCrums() {
        this.appService.updateBreadCrums('SFMS-SUBSIDIARY');
    }

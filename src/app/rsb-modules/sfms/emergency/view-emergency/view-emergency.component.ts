...
import { PersonalInfo, EmployementDetails, EmergencyVehicle, PolicyViewObject } from '../emergency';
...
export class ViewEmergencyComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<ViewEmergencyComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private storage: LocalStorageService,
    private staffService: EmergencyService,
    ...
    this.staffService
      ...
      .subscribe((res) => {
        ...
        responseVehicles.forEach(vehicle => {
          this.vehicles.push(new EmergencyVehicle(vehicle));
        });
      }, (err) => {
  ...
  goToParticularStep(step, message, staffObj) {
    ...
    // setTimeout(() => {
      ...
      this.router.navigate(['/rsb-modules/organization/emergency/manageemergency/prepare']);
    // }, 2000);
  }
}
